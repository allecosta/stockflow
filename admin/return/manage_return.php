...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?= isset($id) ? "Detalhes da Devolução - ".$return_code : 'Criar Novo Registro de Devolução' ?></h4>
    </div>
    <div class="card-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-sm rounded-0" value="<?= isset($return_code) ? $return_code : '' ?>" readonly>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="text-info control-label">Devoluções
                                <textarea 
                                    name="remarks" rows="3" class="form-control rounded-0">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?= BASE_URL.'/admin?page=return' ?>">Cancelar</a>
    </div>
</div>
...
<script>
    ...
    $(function() {
        ...
        $('#item_id').select2({
            placeholder:"Favor selecione o fornecedor primeiro",
            width:'resolve',
        })
