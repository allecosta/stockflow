...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Registro de Venda - <?= $sales_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Cod. de Venda</label>
                    <div><?= isset($sales_code) ? $sales_code : '' ?></div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="client" class="control-label text-info">Nome do Cliente</label>
                        <div><?= isset($client) ? $client : '' ?></div>
                    </div>
                </div>
            </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a 
            ...
            href="<?= BASE_URL .'/admin?page=sales/manage_sale&id='.(isset($id) ? $id : '') ?>">Editar
        </a>
        <a class="btn btn-flat btn-dark" href="<?= BASE_URL . '/admin?page=sales' ?>">Retornar à Lista</a>
    </div>
</div>
