<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient sticky-top">
    <div class="container px-4 px-lg-5 ">
        ...
        <a class="navbar-brand" href="./">
            <img src="<?= validateImage($_settings->info('logo')) ?>" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <?php if (isset($_SESSION['userdata']['id']) && $_settings->userData('type') == 2): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=my_transactions">Minhas Trabsações</a>
                    </li>
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link" href="./?page=about_us">Quem Somos</a></li>
            </ul>
            <div class="navbar-nav ml-auto d-flex align-items-center">
                <?php if (isset($_SESSION['userdata']['id']) && $_settings->userData('type') == 2): ?>
                    <a href="./?page=update_account" class="text-light  nav-link"><b> Olá, <?= $_settings->userData('firstname') ?>!</b></a>
